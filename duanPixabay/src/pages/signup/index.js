...
export let signup =
  ...
  <div class="franit2">
      <div class="khung">
          ...
          <div class="fadu3">
              <input class="text1" type="text" placeholder="UserName or email">
              <input class="text2" type="text" placeholder="PassWord">
              <input class="text2" type="text" placeholder="Confirm PassWord">
